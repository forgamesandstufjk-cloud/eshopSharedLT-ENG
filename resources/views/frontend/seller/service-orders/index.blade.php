                            ...
                            @forelse($orders as $order)
                                <div class="rounded p-3 shadow" style="background-color: rgb(234, 220, 200)">
                                    ...
                                    <div class="mt-3 flex flex-wrap gap-2">
                                        ...
                                        @if(in_array($order->status, [\App\Models\ServiceOrder::STATUS_AGREED, \App\Models\ServiceOrder::STATUS_DAROMAS, \App\Models\ServiceOrder::STATUS_READY_TO_SHIP], true))
                                            <form method="POST" action="{{ route('seller.service-orders.status', $order) }}">
                                                @csrf
                                                @method('PATCH')
